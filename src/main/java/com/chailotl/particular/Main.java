...
public class Main implements ClientModInitializer
{
	...
	public static final SimpleParticleType MANGROVE_LEAF = FabricParticleTypes.simple();
	public static final SimpleParticleType WATER_RIPPLE = FabricParticleTypes.simple();
	public static final SimpleParticleType ENDER_BUBBLE = FabricParticleTypes.simple();
	public static final SimpleParticleType ENDER_BUBBLE_POP = FabricParticleTypes.simple();
	...
	public static final SimpleParticleType WATERFALL_SPRAY = FabricParticleTypes.simple();
